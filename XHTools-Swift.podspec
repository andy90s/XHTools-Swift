...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of XHTools-Swift.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/xhliang/XHTools-Swift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'xhliang' => '909901234@qq.com' }
  s.source           = { :git => 'https://github.com/xhliang/XHTools-Swift.git', :tag => s.version.to_s }
